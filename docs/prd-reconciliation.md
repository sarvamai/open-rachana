...
1. Implement R1's decided placement through reviewed session/API contracts.
   Apply ADR-0013's decided scope boundary. Review R2, R4, R5, R8 and R12
