# Plan: As an Admin, I want to retire an approved question rather than delete it
...
Issue: #84. Companion reference: PR #100; contributor workflow: PR #99.
...
Attempt retirement without permission and repeat a valid request; preserve content/evidence and revoke readiness with an idempotent notification.
