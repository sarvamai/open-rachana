# Plan: As a Translator, I want to create and edit a translation after the original is sealed
...
Issue: #73. Companion reference: PR #100; contributor workflow: PR #99.
...
Try opening a variant before primary seal, modifying the original and accessing an unassigned reference; refuse outside the approved task contract.
