# Plan: As an Admin, I want submit refused when the question is too similar to a sealed question
...
Issue: #62. Companion reference: PR #100; contributor workflow: PR #99.
...
Use synthetic sealed-bank fixtures, empty corpus and similarity-service failure. Never return sealed text or silently pass an unavailable required check.

## Requirement trace

QST03-VAL similarity SPI
